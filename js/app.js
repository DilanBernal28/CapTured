...
function showAlert(message) {
    ...
    alertMessage.style.display = 'block';
    setTimeout(() => {
        alertMessage.style.display = 'none';  // sin esta linea, la linea de abajo 3000 no funciona porque le tenia otras cosas
    }, 4000); // Ocultar el mensaje después de 3 segundos
}
